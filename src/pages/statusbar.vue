  ...
  <f7-page>
    ...
    <f7-block strong>
      ...
      <f7-row tag="p">
        ...
        <f7-button fill class="col" @click="setStatusbarStyle">setStatusbarStyle</f7-button>
      </f7-row>
    </f7-block>
  </f7-page>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      ...
      setStatusbarStyle() {
        this.$f7.statusbar.setTextColor("white");
        this.$f7.statusbar.setBackgroundColor("#ffd900");
      }
    },
  };
</script>
